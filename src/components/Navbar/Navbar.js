                ...
                </div>
                {
                    page === 'calendar'?
                        ...
                        <div className={'d-flex search'}>
                            <input id={'search'} className={'align-self-center m-1 p-1'} placeholder={'Поисковой запрос...'} onChange={(e)=>setSearch(e.target.value)} name={'search'} value={search} type="text"/>
                            {/*<button type="button" className="btn-close"></button>*/}
                            <input className={'btn btn-outline-secondary align-self-center'} type="submit" value="Найти"/>
                        </div>
