                           ...
                           return <div key={index}>
                               <div className={'listLeagues'} key={item.league.id}>
                                   ...
                                   <div className={'d-flex'}>
                                       <a href={`/league/${item.league.id}?season=${year}`} className={'btn btn-outline-primary'}>таблица</a>
                                   </div>
                                   <div className={'calendar'}>
                                       <a onClick={()=>{
                                           saveLocal('league',item.league)
                                       }} href={`/calendar/league/${item.league.id}?season=${year}`} className={'btn btn-outline-primary'}>календарь</a>
                                   </div>
                               </div>
                               <hr className={'hr'} />
                           </div>
